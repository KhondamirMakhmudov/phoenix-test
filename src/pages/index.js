...
export default function Home() {
  return (
    <div className={"min-h-screen  mx-auto"}>
      ...
      <main className="bg-main-section-sky relative z-30 bg-no-repeat bg-cover text-transparent min-h-[879px]">
      <Header />
        <div className="container mx-auto mt-[60px] z-50">
          <h1 className="text-[64px] max-w-[1020px]  tenor-sans-regular text-white">
          Экологически чистые продукты из богатой флоры <span className="text-[#4EB748] underline">Узбекистана</span>
          </h1>

          <p className="text-white tenor-sans-regular my-[30px] text-[20px] max-w-[914px]">
      ...
      <section className="bg-second-section tenor-sans-regular h-screen bg-no-repeat bg-cover">
          <div className="container mx-auto pt-[80px]">
            ...
            <p className="text-[32px] max-w-[875px] mt-[30px] mb-[70px]">
